...
console.log(tyra_obj.weight);

// What was the diet of a velociraptor?
console.log(veloc_obj.diet);

// How long was a stegosaurus?
console.log(stego_obj.length);

// What time period did tyrannosaurus live in?
console.log(tyra_obj.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyra_obj.roar);
...
const universities = graduates.map(function(graduate){
  return {'first_name': graduate.first_name}
});
...
zooAnimals.forEach((animal) => {
  new_line =`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`; 
